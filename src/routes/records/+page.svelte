	...
	<div class="w-full max-w-2xl mx-auto mt-4 fade-in">
		<div class="glass-card p-7 sm:p-10">
			<div class="text-center mb-7">
				<p class="text-xs uppercase tracking-[0.25em] text-rose-700/70 font-semibold mb-2">
					Find a record
				</p>
				<h2 class="font-display italic text-rose-800 text-2xl sm:text-3xl">
					Enter patient information
				</h2>
				<p class="text-ink-soft text-sm mt-2">
					Search by any combination of fields — or view all diagnostic records.
				</p>
			</div>
			...
			<div class="flex flex-col-reverse sm:flex-row items-center justify-between gap-3 mt-8">
				...
				<div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
					...
					<a
						href="/records/all"
						class="pill-btn bg-primary-gradient shadow-md hover:!bg-ink-soft transition-colors text-center"
					>
						Show all records
						<span class="ml-1 px-1.5 py-0.5 rounded-full bg-white/20 text-[10px] font-mono"
